function sortCarByYearDescendingly(cars) {
  ...
  // Implementasi manual sorting secara descending menggunakan algoritma bubble sort
...
const sortedCarss = sortCarByYearDescendingly(carss);
console.log(sortedCarss);
